...
;template <class T> class ListaDEC : public NodoC<T>{//Linea Modificada
...
/***     Fin Elemento                                                       ***/
;template <class T> NodoC<T> * ListaDEC<T>::ini(){
      NodoC<T> *apt(lst);
      return apt;          
...
/***     Elemento: buscar
    ...
    Pre-Condicion: Lista inicializado  
   Post-Condicion: ninguna                                                  ***/
;template <class T> NodoC<T> * ListaDEC<T>::search(T e){//Linea Modificada
         NodoC<T> *apt;
               if(!empty()){
                    apt = lst;
                    int k = 0;
...
;template <class T> void ListaDEC<T>::ordenar2(bool b){//Linea Modificada
         NodoC<T> *tmp;
         if(!empty()){
              if(b){
                  ;tmp = lst;//Linea Modificada
